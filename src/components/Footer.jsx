            ...
            <div className="max-w-6xl mx-auto py-16 px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-off-white/70">
                        <li><a href="#inicio" className="hover:text-gold-accent transition-colors">Inicio</a></li>
                        <li><a href="#servicios" className="hover:text-gold-accent transition-colors">Servicios</a></li>
                        <li><a href="#galeria" className="hover:text-gold-accent transition-colors">Galería</a></li>
                        <li><a href="#contacto" className="hover:text-gold-accent transition-colors">Contacto</a></li>
                    </ul>
                </div>
                <div>
